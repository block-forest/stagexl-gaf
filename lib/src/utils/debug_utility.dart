 ...
 */
 part of stagexl_gaf;
	 ...
	 class DebugUtility
	{
		 ...
		 static final List cHR<int> = new <int>[255, 255, 0, 0, 0, 255, 255];
		 static final List cHG<int> = new <int>[0, 255, 255, 255, 0, 0, 0];
		 static final List cHB<int> = new <int>[0, 0, 0, 255, 255, 255, 0];

		 static final List aryRGB<List.<int>> = new <List<int>>[cHR, cHG, cHB];
