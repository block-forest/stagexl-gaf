 ...
 */
 part of stagexl_gaf;
	 ...
	 class TAGFXSourcePNGBA extends TAGFXBase
	{
		...
		//
		//--------------------------------------------------------------------------
	 TAGFXSourcePNGBA(ByteList source,Point textureSize,[String format="bgra"])
		{
			this._source = source;
		  ...
		  void onPNGLoadError(IOErrorEvent event)
		{
			...
			throw new StateError("Can't restore lost context from a PNG ByteList.", event.errorID);
		}
